...
public class RestWorkload extends CoreWorkload {
    ...
    public void init(Properties p) throws WorkloadException {
        ...
        readRecordCount =
                Integer.parseInt(p.getProperty(READ_RECORD_COUNT_PROPERTY, String.valueOf(Integer.MAX_VALUE)));
        insertRecordCount =
                Integer.parseInt(p.getProperty(INSERT_RECORD_COUNT_PROPERTY, String.valueOf(Integer.MAX_VALUE)));
        deleteRecordCount =
                Integer.parseInt(p.getProperty(DELETE_RECORD_COUNT_PROPERTY, String.valueOf(Integer.MAX_VALUE)));
        updateRecordCount =
                Integer.parseInt(p.getProperty(UPDATE_RECORD_COUNT_PROPERTY, String.valueOf(Integer.MAX_VALUE)));
    ...
    public static DiscreteGenerator createOperationGenerator(final Properties p) {
        ...
        double deleteproportion =
                Double.parseDouble(p.getProperty(DELETE_PROPORTION_PROPERTY, DELETE_PROPORTION_PROPERTY_DEFAULT));
